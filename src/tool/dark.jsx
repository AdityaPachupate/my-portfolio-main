  ...
  return (
    <div className={`${darkMode && "dark"}`}>
      <div className=" dark:bg-black min-h-screen">
        <div className="flex flex-wrap gap-4 justify-between items-center pt-5 px-4 md:px-8 text-gray-700 dark:text-white mb-4">
          <div className=" flex flex-wrap flex-row items-center gap-2 text-base font-sans text-gray-500 font-medium  dark:text-gray-400">
          ...
          <div className=" flex flex-wrap flex-row gap-3">
            <span className="animate-pulse underline font-serif cursor-pointer text-pink-500 border-theme-blue hover:text-gray-700 dark:hover:text-white">
              <Link to="mailto:adityapachupate@gmail.com">Email</Link>
            </span>

            {/* <span className="animate-pulse  font-serif cursor-pointer hover:text-gray-700 dark:hover:text-white">
              |
            </span> */}
